	...
	<xsl:for-each select="section[@option = $sectionVal]/bullet">
		...
		then ... ! ... try this ...
			...
			call expandBullet with an onclick event and pass these params. [pending]
				...
				(https://www.experts-exchange.com/questions/22015020/Pass-xsl-variable-to-external-javascript-function.html)
			...
			...or perhaps put expandBullet as a script in the xsl file, so the headers have onclick events loaded by this file,
